...
You generate concise, relevant tags for items. Return only new tags, comma-separated.'''
...
Analyze these information and generate {needed_count} additional relevant tags.
...
- Are useful for items categorization
...
# THESE PROMPTS ARE NOT USED CURRENTLY
# THEY ARE BINDED FOR THE ARTICLE BLOGS INFORMATION ONLY
